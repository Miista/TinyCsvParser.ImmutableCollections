...
#pragma warning disable CS8618
            public ImmutableArray<int> Ints { get; set; }
#pragma warning restore CS8618
        ...
        public void Test()
        {
            ...
            results.First().Result.Ints.Should().BeEquivalentTo(ImmutableArray<int>.Empty.Add(0).Add(1), because: "that was the values passed");
        }
        ...
        private static (ICsvParser<Data> Parser, CsvReaderOptions ReaderOptions) CreateParser()
        {
            ...
            typeConverterProvider = typeConverterProvider.Add(new ImmutableArrayTypeConverter<int>(typeConverterProvider));
